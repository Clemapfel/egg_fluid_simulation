...
-- for example, if this file is /common/simulation/simulation_handler.lua replace this
...
function SimulationHandler.new(white_config, yolk_config)
    if yolk_config == nil then yolk_config = white_config end
    log.assert(white_config, "table", yolk_config, "table")
    ...
    self:_load_config(self:_deepcopy(white_config), true) -- white
    self:_load_config(self:_deepcopy(yolk_config), false) -- yolk
